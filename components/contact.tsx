        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10">
            <a
              ...
              className="inline-flex h-14 items-center justify-center gap-3 rounded-xl bg-emerald-500 px-10 text-base font-semibold text-white shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-600 hover:scale-105"
            >
          ...
          <div className="mt-8 flex flex-col items-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="font-medium text-foreground">willian_ramthun@hotmail.com</span>
            <span className="mt-1">Rio Grande do Sul, RS — atendo em todo o Brasil</span>
          </div>
        </div>
      </div>
    </section>
